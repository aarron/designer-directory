			...
			<nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
			  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
				...
				<Link href="http://designbetter.com" legacyBehavior>
				  <a className="flex items-left space-x-3 rtl:space-x-reverse">
					<img
					  className="w-20"
				...
				<div className="hidden w-full md:block md:w-auto" id="navbar-default">
				  <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
					<li>
					  <Link href="/" className="block py-2 px-3 rounded-sm md:bg-transparent">
						Home
					  </Link>
					</li>
					<li>
					  <Link href="https://forms.gle/MyArHLPThBEnjBo57" legacyBehavior>
						<a target="_blank" className="block py-2 px-3">
						  Submit a profile
						</a>
					  </Link>
					</li>
